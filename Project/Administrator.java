 ...
 *
 * Currently inherits all behaviour directly from Account.
 ...
 * without modifying the base Account class.
 *
 * Administrator privileges are currently determined at runtime by the
 * "ADMIN" role string stored in the accounts CSV and checked via
 * Account#isAdmin().
 */
